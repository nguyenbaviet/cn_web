          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a class="py-2 d-block">Register</a></li>
                <li><a class="py-2 d-block">Post a Job</a></li>
                <li><a class="py-2 d-block">Advance Skill Search</a></li>
                <li><a class="py-2 d-block">Recruiting Service</a></li>
                <li><a class="py-2 d-block">Blog</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a class="py-2 d-block">How it works</a></li>
                <li><a class="py-2 d-block">Register</a></li>
                <li><a class="py-2 d-block">Post Your Skills</a></li>
                <li><a class="py-2 d-block">Job Search</a></li>
                <li><a class="py-2 d-block">Emploer Search</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a><span class="icon icon-envelope"></span><span class="text">info@yourdomain.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
